...
**2. Entrenar un modelo especializado en Cisco (LoRA):** El script finetune_model.py:
...
**3. Ejecutar un agente inteligente con tools (LangGraph):**
  ...
  Además: Analiza prompts del usuario, Decide si usar una tool o responde directamente con comandos Cisco IOS.

**4. Usar el modelo en local o con HF:** El repositorio incluye un archivo test.py para probar inferencia local.
...
Incluye configuraciones de: Interfaces, VLAN, DHCP, OSPF, NAT, ACL, DNS y Escenarios enseñados manualmente.

# **Tecnologías Usadas**

    Python 3.12, Transformers, PEFT / LoRA, BitsAndBytes, LangGraph, Hugging Face Hub

# Contacto
Hecho por: 

- Juan Jose Angel Duran Calvache, joseduran@unicauca.edu.co.
